//
//  BookclubInitial1ViewController.swift
//  New_Bookspeare
//
...
class BookclubInitial1ViewController: UIViewController {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if collectionView == exploreCollectionView
        {
            ...
            case 0:
                let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "First", for: indexPath) as! FirstBookclubCollectionViewCell
            ...
            case 1:
                let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "Second", for: indexPath) as! SecondBookclubCollectionViewCell
                cell.bookclubName.text = bookclubs[indexPath.row].name
                cell.bookclubMembers.text = "200"
                cell.bookclubDescription.text = "Community for book lovers" // Set a default value or fetch from your data source
                if let imageName = bookclubs[indexPath.row].image as String? {
                ...
                return cell
            case 2:
                let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "Third", for: indexPath) as! ThirdBookclubCollectionViewCell
                cell.bookclubName.text = bookclubs[indexPath.row].name
                cell.bookclubMembers.text = "200"
                cell.bookclubDescription.text = "Community for book lovers" // Set a default value or fetch from your data source
                if let imageName = bookclubs[indexPath.row].image as String? {
    ...
    @IBSegueAction func createClub(_ coder: NSCoder) -> CreateClubsViewController? {
        return CreateClubsViewController(coder: coder, bookclub: nil)
    }
    ...
    @IBAction func unwindToCommunity(unwindSegue: UIStoryboardSegue)
    {
        guard unwindSegue.identifier == "saveUnwind",
              let sourceViewController = unwindSegue.source as? CreateClubsViewController,
